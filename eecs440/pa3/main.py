...
if __name__ == "__main__":
    ...
    svm_parser.add_argument('--is_linear', type=int, help='whether using linear SVM', default=1)  # whether using linear svm: 1 means using linear svm, 0 means using svm with quadratic kernel (x'*y+1)^2 

    nbayes_parser = subparsers.add_parser('nbayes', help='Naive Bayes')
    nbayes_parser.add_argument('--m', type=float, help='Smoothing parameter for Naive Bayes', default=1)
